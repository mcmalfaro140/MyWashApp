    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.pickDateBtn.setOnClickListener {
            val dpd = DatePickerDialog(activity!!, DatePickerDialog.OnDateSetListener { view, year, month, dayOfMonth ->
                ...
                binding.dateTv.setText("" + month + " / " + dayOfMonth + " / " + year)
            }, year, month, day)
            dpd.show()
        }
        ...
        spinner3?.adapter = ArrayAdapter(activity!!.applicationContext, R.layout.support_simple_spinner_dropdown_item, times)
        ...
        binding.spinner3.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent:AdapterView<*>, view: View, position: Int, id: Long){
                ...
                binding.textViewTime.text = "${parent.getItemAtPosition(position).toString()}"
            }
        ...
        //val buttonConfirm = t.findViewById<Button>(R.id.confirm_button)
        confirm_button.setOnClickListener {
            activity?.let{
                val intent = Intent (getActivity(), ConfirmationActivity::class.java)
